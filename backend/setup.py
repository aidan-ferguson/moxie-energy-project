...
"""
from setup.download_dale_data import *
from setup.download_national_averages import *
import os
...
if __name__ == "__main__":
    ...
    print(f"Downloaded & Combined UK postcode usage datasets to {os.path.join(DATASET_FOLDER, 'postcodes')}")